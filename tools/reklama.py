...
async def cmd_post(message: types.Message, bot: Bot, get_all_users):
    ...
    link_text = "Если вас нет в наших ресурсах, то скорее нажминайте кнопку и вступайте. ТАКЖЕ переходите скорее в наш чат, потому что там будет разыгрываться ФармКоины за актив! 👇"
